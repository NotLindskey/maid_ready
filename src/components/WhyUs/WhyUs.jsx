...
function AboutPage() {
  ...
  return (
    <div className="container">
      <div >
       <h2 className="why-header">WHY US?</h2>
      </div>
      <div className="why-container">
        ...
        <p>
            ...
            Think of Maid!Ready! as your one-stop shop for all your cleaning needs. Our platform works like "Uber" for cleaning services, where owners can post a job with details such as pay rate, address, and a task list that is available to "keepers". Keepers can then log in to Maid!Ready! and choose jobs based on their distance preferences, making it easy to find work that fits their lifestyle.
      ...
      <div>  
      <button className="btn" onClick={() => {history.goBack()}} value="Cancel">Go Back</button>
      </div>
    </div>
  );
}
